REM		GMT EXAMPLE 06
REM
REM		$Id: example_06.bat 16584 2016-06-20 22:22:41Z pwessel $
REM
...
gmt psrose fractures.txt -: -A10r -S1.8in -P -Gorange -R0/1/0/360 -X2.5i -K -Bx0.2g0.2 -By30g30 -B+glightblue -W1p > %ps%
