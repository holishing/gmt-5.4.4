REM		GMT EXAMPLE 28
REM		$Id: example_28.bat 17714 2017-03-18 01:23:31Z pwessel $
REM
...
gmt grdimage Kilauea.utm.nc -I+a45+nt1 -CKilauea.cpt -Jx1:160000 -P -K --FORMAT_FLOAT_OUT=%%.10g --FONT_ANNOT_PRIMARY=9p --MAP_GRID_CROSS_SIZE_PRIMARY=0.1i > %ps%
...
gmt psbasemap -R -J -O -K -LjRB+c19:23N+f+w5k+l1:16,000+u+o0.2i --FONT_ANNOT_PRIMARY=10p --FONT_LABEL=10p >> %ps%
