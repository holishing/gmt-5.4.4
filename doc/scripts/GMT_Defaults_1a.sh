#!/bin/bash
#	$Id: GMT_Defaults_1a.sh 13471 2014-08-25 18:47:31Z pwessel $
#
ps=GMT_Defaults_1a.ps
gmt gmtset MAP_FRAME_TYPE fancy FORMAT_GEO_MAP ddd:mm:ssF MAP_GRID_CROSS_SIZE_PRIMARY 0.1i FONT_ANNOT_PRIMARY +8p
